...
const SignUpPage = () => {
  ...
  // <-- Add page title
  useEffect(() => {
    document.title = "RK Sprinklers – Sign Up";
  }, []);
  ...
  const handleSignUp = async (e) => {
    ...
    console.log({ name, email, password, number, street, city, zipCode });

    try {
      await signup(email, password, name, number, street, city, zipCode);
